...
async function loadWind(url) {
    ...
    console.log("Echts Datum Vorhersage",forecastDate);
    console.log("Vohersagezeitpunkt", formatDate(forecastDate));
    ...
    L.velocityLayer({
        ...
        displayOptions:{
            ...
            speedString: "Winggeschwindigkeit",
            speedUnit: "k/h",
...
layerControl.addOverlay(overlays.weather, "Wettervorhersage met.no");
    ...
    //console.log("Jsondaten",jsondata);
        ...
        let popup = ` 
            ...
            <li>Windrichtig: ${details.wind_from_direction} (°)</li>
            ...
            for (let i=0; i <= 24; i+=3 ){
                ...
                popup += `<img src="icons/${symbol}.svg" title="${forecastLabel}" alt="${symbol}"
                style="width:32px">`;
            }
...
// auf Klick auf die Karte reagiren
